							...
							<aside class="sidebar mt-2" id="sidebar">
								<div class="tabs tabs-vertical tabs-right tabs-navigation tabs-simple">
									<ul class="nav nav-tabs col-sm-3">
										<li class="nav-item">
											<a class="nav-link active" href="#tabsNavigationVertSimple1" data-bs-toggle="tab">My Profile</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#tabsNavigationVertSimple2" data-bs-toggle="tab">Download</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#tabsNavigationVertSimple3" data-bs-toggle="tab">Membership</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#tabsNavigationVertSimple4" data-bs-toggle="tab">Social Media</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#tabsNavigationVertSimple5" data-bs-toggle="tab">Notification</a>
										</li>
										<li class="nav-item">
							...
							<div class="tab-pane tab-pane-navigation active" id="tabsNavigationVertSimple1">
								<form role="form" class="needs-validation">
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input class="form-control text-3 h-auto py-2" type="text" name="firstName" value="Prashant" required>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-3 col-form-label form-control-label line-height-9 pt-2 text-2 required">Last name</label>
										<div class="col-lg-9">
											<input class="form-control text-3 h-auto py-2" type="text" name="lastName" value="Bhamare" required>
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										<label class="col-lg-3 col-form-label form-control-label line-height-9 pt-2 text-2">Cureent Role</label>
										<div class="col-lg-9">
