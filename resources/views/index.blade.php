...
<div role="main" class="main">
								...
								<div class="col-half-section col-half-section-right custom-header-max-width-1 ms-auto justify-self-end">
									...
									<div class="d-flex counters pt-3">
									    <div class="custom-counter-1 pe-4">
									        <div>
									            <h3 data-append=" +" data-to="95" class="mb-0">
									                0
									            </h3>
									    ...
									    <div class="custom-counter-1 ps-3">
									        <div>
									            <h3 data-append=" K+" data-to="50" class="mb-0">
									                0
									            </h3>
									            <svg version="1.2" xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 117 12" width="117" height="12">
									                <g>
							...
							<div class="col-10 col-lg-5 intro-img-slider text-right py-5 pt-lg-0 p-relative mx-auto">
								<div class="d-inline-block ml-auto p-relative custom-banner-content-1">
									<div class="d-flex align-items-center m-2 p-1">
										<img src="{{ asset('') }}img/landing/browser-icons-1.svg" alt="" width="26" height="26" />
										<img src="{{ asset('') }}img/landing/browser-icons-2.svg" alt="" class="ms-1" width="40" height="10" />
									</div>
									<div class="custom-banner-content-item-1 floating" data-plugin-float-element data-plugin-options="{'speed': 0.03, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
										<img src="{{ asset('') }}img/landing/color-picker.png" class="img-fluid" />
									</div>
									...
									<div class="custom-banner-content-item-2 d-none d-xl-block bg-dark p-3">
										<ul class="list-inline custom-list-icons-1 text-color-light m-0">
											...
											<li class="list-inline-item ms-3">
												...
												<strong class="font-weight-semibold negative-ls-05">Style Switcher</strong>
											</li>
											<li class="list-inline-item ms-3">
												<span class="custom-list-icon bg-light text-color-dark negative-ls-1">
						...
						<div class="row">
							<div class="col-md-8 col-lg-6 custom-header-bar position-relative py-4 pe-5 z-index-2">
								<div>
									...
									<p class="position-relative text-center font-weight-normal mb-1">* 50K+ Trust Porto - Since 2013</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row portfolio-list sort-destination sort-destination-margin sort-destination-items-hardware-acc overflow-visible mt-4" data-sort-id="portfolio">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-classic.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business new" data-sort-search="Marketing 1">
									<div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-marketing-1.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 z-index-hover-1 isotope-item business">
									<div class="portfolio-item hover-effect-1 text-center">
										...
										<div class="owl-carousel nav-dark show-nav-hover show-nav-hover-pos-2 nav-rounded nav-md" data-plugin-options="{'items': 1, 'margin': 10, 'loop': true, 'nav': true, 'dots': false, 'autoplay': true, 'autoplayTimeout': 5000, 'autoplayHoverPause': true}">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											...
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="{{ asset('') }}img/previews/preview-auto-services-DA1526.jpg">
													<a href="demo-auto-services.html?colorPrimary=DA1526&colorSecondary=EC2738&colorTertiary=F9F9F9&colorQuaternary=121212&showStyleSwitcher=true&hideStyleSwitcherAfterShow=true&addImagesSuffix=true&addURLParams=true" target="_blank"></a>
												</span>
											</span>

											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="{{ asset('') }}img/previews/preview-auto-services-F24E25.jpg">
													<a href="demo-auto-services.html?colorPrimary=F24E25&colorSecondary=F9523D&colorTertiary=F9F9F9&colorQuaternary=121212&showStyleSwitcher=true&hideStyleSwitcherAfterShow=true&addImagesSuffix=true&addURLParams=true" target="_blank"></a>
												</span>
											</span>

											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="{{ asset('') }}img/previews/preview-auto-services-EDB302.jpg">
													<a href="demo-auto-services.html?colorPrimary=EDB302&colorSecondary=FFC716&colorTertiary=F9F9F9&colorQuaternary=121212&showStyleSwitcher=true&hideStyleSwitcherAfterShow=true&addImagesSuffix=true&addURLParams=true" target="_blank"></a>
												</span>
											</span>
								...
								<div class="col-sm-6 col-md-4 col-lg-3 z-index-hover-1 isotope-item portfolio new">
									<div class="portfolio-item hover-effect-1 text-center portfolio-item-new">
										...
										<div class="owl-carousel nav-dark show-nav-hover show-nav-hover-pos-2 nav-rounded nav-md" data-plugin-options="{'items': 1, 'margin': 10, 'loop': true, 'nav': true, 'dots': false, 'autoplay': true, 'autoplayTimeout': 7000, 'autoplayHoverPause': true}">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="{{ asset('') }}img/previews/preview-creative-agency-2.jpg">
													<a href="demo-creative-agency-2.html" target="_blank"></a>
												</span>
											</span>

											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="{{ asset('') }}img/previews/preview-creative-agency-2-0088CC.jpg">
													<a href="demo-creative-agency-2.html?colorPrimary=0088CC&colorSecondary=0169fe&colorTertiary=F9F9F9&colorQuaternary=121212&showStyleSwitcher=true&hideStyleSwitcherAfterShow=true&addImagesSuffix=true&addURLParams=true" target="_blank"></a>
												</span>
											</span>

											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="{{ asset('') }}img/previews/preview-creative-agency-2-FF7049.jpg">
													<a href="demo-creative-agency-2.html?colorPrimary=FF7049&colorSecondary=FF5B2F&colorTertiary=F9F9F9&colorQuaternary=121212&showStyleSwitcher=true&hideStyleSwitcherAfterShow=true&addImagesSuffix=true&addURLParams=true" target="_blank"></a>
												</span>
											</span>
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 8">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-8.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 z-index-hover-1 isotope-item business">
									<div class="portfolio-item hover-effect-1 text-center">
										...
										<div class="owl-carousel nav-dark show-nav-hover show-nav-hover-pos-2 nav-rounded nav-md" data-plugin-options="{'items': 1, 'margin': 10, 'loop': true, 'nav': true, 'dots': false, 'autoplay': true, 'autoplayTimeout': 9000, 'autoplayHoverPause': true}">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											...
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
												<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link lazyload m-0" data-bg-src="{{ asset('') }}img/previews/preview-business-consulting-3-0088CC.jpg">
													<a href="demo-business-consulting-3.html?colorPrimary=0088CC&colorSecondary=149CE0&colorTertiary=0074B8&colorQuaternary=383F48&showStyleSwitcher=true&hideStyleSwitcherAfterShow=true&addImagesSuffix=true&addURLParams=true" target="_blank"></a>
												</span>
											</span>
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="startup agency">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-startup-agency.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="architecture 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-architecture-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="cleaning services">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-cleaning-services.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="insurance">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-insurance.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="business consulting 4">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-business-consulting-4.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="business consulting 5">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-business-consulting-5.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="transportation logistic">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-transportation-logistic.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="renewable energy">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-renewable-energy.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="industry factory">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-industry-factory.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="seo">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-seo.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="law firm 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-law-firm-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="construction">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-construction.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="construction 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-construction-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="creative agency">
									<div class="portfolio-item hover-effect-1 text-center ">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-creative-agency-1.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="personal portfolio">
									<div class="portfolio-item hover-effect-1 text-center ">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-personal-portfolio-1.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="personal portfolio">
									<div class="portfolio-item hover-effect-1 text-center ">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-personal-portfolio-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="personal portfolio">
									<div class="portfolio-item hover-effect-1 text-center ">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-personal-portfolio-3.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="seo 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-seo-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="seo 3">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-seo-3.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="business consulting">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-business-consulting.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="business consulting 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-business-consulting-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="medical">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-medical.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="medical 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-medical-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="dentist">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-dentist.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="finance">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-finance.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="it services">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-it-services.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item shop" data-sort-search="product landing">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-product-landing.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="coffee shop">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-coffee.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="sass">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-sass.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="architecture interior design">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-architecture-interior.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="beauty salon">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-beauty-salon.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="barber shop">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-barber.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="education">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-education.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="digital agency">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-digital-agency.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="digital agency 2 light">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-digital-agency-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="digital agency 2 dark">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-digital-agency-2-dark.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="app landing">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-app-landing.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="law firm">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-law-firm.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 z-index-hover-1 isotope-item portfolio creative z-index-1">
									<div class="portfolio-item hover-effect-1 text-center">
										...
										<div class="owl-carousel nav-dark show-nav-hover show-nav-hover-pos-2 nav-rounded nav-md" data-plugin-options="{'items': 1, 'margin': 10, 'loop': true, 'nav': true, 'dots': false, 'autoplay': true, 'autoplayTimeout': 3000, 'autoplayHoverPause': true}">
											<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="hotel">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-hotel.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="hotel">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-hotel-boxed.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="real estate">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-real-estate.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item creative business" data-sort-search="event">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-event.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="restaurant">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-restaurant.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="gym">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-gym.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item onepage creative business" data-sort-search="band">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-band.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item onepage creative" data-sort-search="one page agency">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-one-page-agency.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="photography">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-photography.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="photography 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-photography-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="photography 3">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-photography-3.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="church">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-church.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="wedding">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-wedding.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item onepage" data-sort-search="one page">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-one-page.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 1">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 3">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-3.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 4">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-4.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 5">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-5.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 6">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-6.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 7">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-7.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 9">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-9.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 10">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-10.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 11">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-11.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 12">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-12.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 13">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-13.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 14">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-14.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 15">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-15.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 16">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-16.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 17">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-17.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 18">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-18.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 19">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-19.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 20">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-20.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="corporate 21">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-21.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 1">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-portfolio.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-portfolio-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 3">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-portfolio-3.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 4">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-portfolio-4.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item portfolio" data-sort-search="portfolio 5">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-portfolio-5.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 1">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-blog.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 2">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-blog-2.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 3">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-blog-3.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 4">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-blog-4.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item blog" data-sort-search="blog 5">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-blog-5.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item business" data-sort-search="hosting">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-corporate-hosting.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic color">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-classic-color.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic light">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-classic-light.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic video">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-classic-video.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="classic video light">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-classic-video-light.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="boxed">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-boxed.jpg);">
								...
								<div class="col-sm-6 col-md-4 col-lg-3 isotope-item classic" data-sort-search="rtl">
									<div class="portfolio-item hover-effect-1 text-center">
										<span class="thumb-info thumb-info-no-zoom thumb-info-no-overlay thumb-info-no-bg">
											<span class="thumb-info-wrapper thumb-info-wrapper-demos thumb-info-wrapper-link m-0" style="background-image: url(img/previews/preview-rtl.jpg);">
				...
				<section class="section section-no-border pb-0 mt-3 mb-0">
					<div class="container pt-4">
						...
						<div class="image-wrapper position-relative z-index-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-appear-animation-duration="750" style="height: 0; padding-bottom: 16%;">
							<img src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/theme_options.png" class="lazyload img-fluid" alt="The Most Customizable Template">
						</div>
					</div>
				</section>

				<section class="section section-no-border section-angled section-dark pb-0 m-0" style="background-repeat: no-repeat; background-color: #0169fe !important;" data-src="{{ asset('') }}img/landing/reason_bg.png">
						...
						<div class="row align-items-center pt-md-5 mt-5">
							<div class="col-lg-6 offset-lg-1 position-relative mb-5">
								<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500">
									<img src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_dots.png" width="154" height="146" class="lazyload position-absolute top-auto" alt="6 reasons" data-plugin-float-element data-plugin-options="{'startPos': 'none', 'speed': 3, 'transition': true}" style="bottom: 184px; left: 70px;">
								</div>
							...
							<div class="col-lg-11">	
								<div class="row justify-content-center">
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" data-appear-animation-duration="750">
										<img class="lazyload img-fluid" alt="Speed Performance" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/reason1.png">
									...
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800" data-appear-animation-duration="750">
										<img class="lazyload img-fluid" alt="Solid and tested base" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/reason2.png">
										<div class="d-flex align-items-center mb-2">
									...
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000" data-appear-animation-duration="750">
										<img class="lazyload img-fluid" alt="Top designs created by usability specialists" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/reason3.png">
										<div class="d-flex align-items-center mb-2">
									...
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300" data-appear-animation-duration="750">
										<img class="lazyload img-fluid" alt="The best customer experience" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/reason4.png">
										<div class="d-flex align-items-center mb-2">
									...
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-appear-animation-duration="750">
										<img class="lazyload img-fluid" alt="Works perfectly with Porto Admin Template" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/reason5.png">
										<div class="d-flex align-items-center mb-2">
									...
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700" data-appear-animation-duration="750">
										<img class="lazyload img-fluid" alt="Always keep template updates" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/reason6.png">
										<div class="d-flex align-items-center mb-2">
				...
				<section class="section section-no-border section-angled bg-color-grey m-0">
					...
					<div class="container py-5 my-5">
						<div class="row align-items-center text-center my-5">
							<div class="col-md-6">
								...
								<p class="appear-animation text-3" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">* Porto Admin <strong class="text-dark">is not included</strong> in the front-end and is available for $12.</p>
							</div>
							<div class="col-md-6 position-relative py-5">
								<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500">
									<img class="lazyload" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_dots2.png" alt="" width="149" height="142" style="position: absolute; top: -60px; right: -8%;">
								</div>
								<div class="appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="0" data-appear-animation-duration="750">
									<div class="strong-shadow rounded strong-shadow-top-right">
										<img src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_admin.jpg" class="lazyload img-fluid border border-width-10 border-color-light rounded box-shadow-3" alt="Porto Admin" />
									</div>
								</div>
							</div>
						</div>
				...
				<section class="section border-0 section-dark section-angled section-angled-reverse section-funnel m-0 position-relative overflow-visible" style="background-image: url(img/landing/porto_performance_bg.png); background-size: 100%; background-position: top; background-repeat: no-repeat;" data-bg-src="">
					...
					<img class="img-fluid position-absolute d-none d-lg-block lazyload appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300" data-appear-animation-duration="750" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_notebook.png" alt="Performance on Laptop" style="display: block; top: -170px; left: 90px;">
						...
						<div class="row align-items-center pb-md-5 mb-md-5">
							...
							<div class="col-5 d-none d-md-block">
								<div class="text-end me-3 me-lg-5 ms-auto mb-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="600" data-appear-animation-duration="750" style="max-width: 244px;" data-plugin-options="{'accY': -100}">
									<img class="img-fluid lazyload" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_iphone.png" width="244" height="228" alt="Performance on Mobile">
								</div>
								<img class="img-fluid appear-animation z-index-1 position-relative lazyload" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="800" data-appear-animation-duration="750" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_ipad.png" width="437" height="241" alt="Performance on Tablet" style="margin-bottom: -10%">
							</div>
						</div>
					</div>
				</section>

				<section class="section border-0 m-0 bg-dark section-dark" style="background-size: 100%; background-position: top;" data-bg-src="{{ asset('') }}img/landing/header_builder_bg.jpg">
					<div class="container">
						<div class="row align-items-center pb-5 mb-5">
							<div class="col-lg-6 pe-lg-5 position-relative text-center mb-5 mb-lg-0">
								<img alt="Porto Headers" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_headers.png" class="img-fluid lazyload appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300" />
							</div>
				...
				<section class="section section-funnel border-0 bg-light lazyload m-0" style="background-size: 100%; background-repeat: no-repeat; background-position: top;" data-bg-src="{{ asset('') }}img/landing/half_circle.png">
						...
						<div class="row flex-column flex-lg-row justify-content-center align-items-center my-5">
							<div class="col-8 col-md-5 col-lg-3 image-box mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" data-appear-animation-duration="750">
								<div class="image mb-3">
									<img alt="Layouts" width="195" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_layouts1.png" class="position-relative z-index-3 lazyload me-auto" style="width: 67.47%; left: -51px;">
									<img alt="Layouts" width="174" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_layouts3.png" class="position-relative z-index-1 lazyload ms-auto" style="width: 60.2%; margin-top: -32%; right: -50px;">
									<img alt="Layouts" width="174" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_layouts3.png" class="position-relative z-index-2 lazyload mx-auto" style="width: 60.2%; margin-top: -13%;">
								</div>
							...
							<div class="col-8 col-md-5 col-lg-3 image-box mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800" data-appear-animation-duration="750">
								<div class="image mb-3">
									<img alt="Sidebars" width="172" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_sidebars1.png" class="position-relative z-index-1 lazyload ms-auto" style="right: -33px;">
									<img alt="Sidebars" width="172" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_sidebars2.png" class="position-relative z-index-2 lazyload" style="left: -19px; margin-top: -32%;">
									<img alt="Sidebars" width="172" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_sidebars3.png" class="position-relative z-index-3 lazyload ms-auto" style="right: -20px; margin-top: -13%;">
								</div>
							...
							<div class="col-8 col-md-5 col-lg-3 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000" data-appear-animation-duration="750">
								<div class="image mb-3">
									<img alt="Sliders" width="142" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_sliders1.png" class="position-relative z-index-1 lazyload" style="left: -31px;">
									<img alt="Sliders" width="142" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_sliders2.png" class="position-relative z-index-2 lazyload ms-auto" style="right: -60px; margin-top: -31%">
									<img alt="Sliders" width="142" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_sliders3.png" class="position-relative z-index-3 lazyload ms-auto" style="margin-right: 15%; margin-top: -41%;">
									<img alt="Sliders" width="142" height="161" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_sliders4.png" class="position-relative z-index-4 lazyload" style="left: -50px; margin-top: -35.67%;">
								</div>
					...
					<div class="section-funnel-layer-bottom">
						<div class="section-funnel-layer bg-color-grey"></div>
						<div class="section-funnel-layer bg-color-grey"></div>
					</div>
				</section>
				...
				<section class="section section-funnel position-relative border-0 pt-0 m-0">
					<div class="container pb-5 mb-5">
						<h2 class="fotn-weight-extra-bold mb-1 text-center">
							<b class="text-13 d-block line-height-1 font-weight-extra-bold appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="250" data-appear-animation-duration="750">50K+</b>
					...
					<div class="container pb-5 mb-5">
						<div class="row align-items-center mb-5">
							...
							<div class="col-lg-4 offset-lg-2 position-relative">
								<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500">
									<img class="img-fluid lazyload" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_dots2.png" alt="" style="position: absolute; bottom: -2%; left: -43%; transform: rotate(90deg)">
								</div>
								<img alt="Porto Support" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/support_login.jpg" class="img-fluid border border-width-10 border-color-light rounded box-shadow-3 lazyload ms-5 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="200" style="width: 590px; max-width: none;">
								<img alt="Porto Documentation" src="{{ asset('') }}img/lazy.png" data-src="{{ asset('') }}img/landing/porto_docs.jpg" class="img-fluid lazyload rounded box-shadow-3 position-absolute appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="700" style="left: -100px; bottom: 50px;">
							</div>
						</div>
					</div>
				...
				<section class="section section-dark section-angled border-0 lazyload pb-0 m-0" style="background-size: 100%; background-position: top;" data-bg-src="{{ asset('') }}img/landing/build_bg.jpg">
					<div class="section-angled-layer-top section-angled-layer-increase-angle bg-color-grey" style="padding: 4rem 0;"></div>
