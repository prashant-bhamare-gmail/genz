			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
						...
						data-appear-animation="fadeInRightShorter" data-appear-animation-delay="100">Leadership Team</h1>
					</div>
						...
						<div class="row team-list sort-destination" data-sort-id="team">
											...
											<div class="modal-body">
												<div class="row mb-4">
													...
													<div class="col-md-9">										
														...
														<p class="lead">Curabitur pellentesque neque eget diam posuere porta. Quisque ut 
															nulla at nunc vehicula lacinia. Proin adipiscing porta tellus, ut feugiat nibh 
							...
							<div class="col-md-3 isotope-item other">
								<div class="team-item mb-4 p-0 pb-2" data-bs-toggle="modal" data-bs-target="#largeModal">
									<a href="#" class="text-decoration-none">
										<span class="image-wrapper">
											<img src="img/gen_img/team-3.jpg" alt="" class="img-fluid" />
										</span>
									</a>
									<div class="team-infos">
										<a href="#" class="text-decoration-none">
